...
PGPASSWORD=postgres dropdb -e -U postgres -w -h localhost newbrief

PGPASSWORD=postgres createdb -e -U postgres -w -h localhost newbrief

activator clean

activator -Dconfig.file=conf/application.conf run
